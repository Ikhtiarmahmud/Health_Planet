        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])){
                    $user = $userdata->userupdateprofile($_POST,$_FILES);
                }
                ?>
                <?php
                if(isset($user)){
                ...
                if($getdata) {
                    while ($result = $getdata->fetch_assoc()) {
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="mt-4">
                            ...
                            <div>
                                <input type="number" name="number" class="form-control" value="<?php echo $result['number']?>">
                            </div>
                            <div>
                            ...
                            <div>
                                <input type="text" name="lastblooddate" class="form-control" value="<?php echo $result['lastblooddate']?>">
                            </div>
                            <div>
