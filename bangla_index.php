    ...
    <div class="container-fluid">
        <div class="row">
            <div class="leftsidebar col-md-3">
                ...
                if($getdata) {
                    while ($result = $getdata->fetch_assoc()) {
                        ...
                        <a class="text-center p-2 btn btn-info" href="bangla_userprofile.php?userid=<?php echo $result['userid']?>">প্রোফাইল</a>
                        <?php
                    }
                }
                ?>
            ...
            <div class="middlecontent col-md-7">
                <h3 class="text-center"><a href="bangla_userpost.php">ইউজার পোস্ট পড়ুন <i class="fas fa-hand-point-right"></i></a></h3>
                ...
                <div class="pagination clear mt-2">
                    <?php
                    echo "<a href='bangla_index.php?page=1'>" . "First page" . "</a>";
                    for ($i = 1; $i <= $total_page; $i++) {
                        echo "<a href='bangla_index.php?page" . $i . "'>" . $i . "</a>";
                    }
                    echo "<a href='bangla_index.php?page=$total_page'>" . "Last page" . "</a></span>";
                    ?>
                    <!--pagination-->
                </div>
                <?php } ?>
            ...
            <div class="rightsidebar col-md-2">
                <h3 class="text-center">সক্রিয় ডাক্তার</h3>
                <div>
                    <ul class="list-unstyled">
                        <li><a href="#"><i class="fas fa-angle-double-right"></i>&nbsp;Eye Specialist </a>
                            <ul class="list-group list-unstyled">
                                ...
                                if($getdata){
                                    while($result = $getdata->fetch_assoc()){ ?>
                                <li><a href="bangla_Doctor_Profile_for_user.php?doctorid=<?php echo $result['doctorid']?>"><?php echo $result['firstname']?>&nbsp;<?php echo $result['lastname']?></a>&nbsp;&nbsp;<span></span> </li>
                                <?php
                                    }
                                }
                                ?>
