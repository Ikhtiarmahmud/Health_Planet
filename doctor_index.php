            ...
            <div class="leftsidebar col-md-3">
                ...
                if($getdata) {
                    while ($result = $getdata->fetch_assoc()) {
                        ...
                        <a class="text-center p-2 btn btn-info" href="Doctor_Profile.php?doctorid=<?php echo $result['doctorid']?>">View Profile</a>
                        <?php
                    }
                }
                ?>
            ...
            <div class="middlecontent col-md-7">
               ...
               /* $getpost = $doctordata->getdoctorpost();*/
                ...
                <div class="pagination clear mt-2">
                    <?php
                    echo "<a href='doctor_index.php?page=1'>" . "First page" . "</a>";
                    for ($i = 1; $i <= $total_page; $i++) {
                        echo "<a href='doctor_index.php?page" . $i . "'>" . $i . "</a>";
                    }
                    echo "<a href='doctor_index.php?page=$total_page'>" . "Last page" . "</a></span>";
                    ?>
                    <!--pagination-->
                </div>
                <?php } ?>
