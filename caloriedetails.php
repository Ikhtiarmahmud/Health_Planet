        ...
        <div class="row">
            ...
            if($dlogin == true){ ?>
                <div class="leftsidebar col-md-5 ">
                    <h3 class="text-center"><a href="#"><i class="fab fa-blogger"></i>&nbsp;Add Food and Calorie</a></h3>
                    <?php
                    if(isset($user)){
                        echo $user;
                    }
           ...
           <?php }
            ...
            <div class="middlecontent col-md-7">
                <h3 class="text-center"><a href="calori.php">Food's Calorie&nbsp;<i class="fas fa-eye"></i></a></h3>
                    <form action="caloriedetailssearch.php" class="row" method="get">
