    ...
    <div class="container-fluid">
        <div class="row">
                ...
                if($getdata) {
                    while ($result = $getdata->fetch_assoc()) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a href="bangla_inbox.php?inboxid=<?php echo $result['doctorid']?>"><span class="btn btn-info d-block">কন্টাক্ট</span></a>
            ...
            <div class="middlecontent col-md-6 ">
                <h3 class="text-center"><a href="#"><i class="fab fa-blogger"></i>&nbsp;আর্টিকেল লিখুন</a></h3>
                <?php
                if(isset($user)){
                    echo $user;
                }
